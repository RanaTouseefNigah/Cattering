<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="catterng.User.Registration" %>
        ...
        function ImagePreview(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function (e) {
                    $('#<%=imgUser.ClientID %>').attr('src', e.target.result).width(200);
                };
                ...
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div>
                            ...
                            <asp:RegularExpressionValidator ID="revMobile" runat="server" ErrorMessage="Mobile No Must be 11 Numbers"
                ...
                <div class="col-md-6">
                    <div class="form_container">
                        <div>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Address is Required" ControlToValidate="txtAddress"
                                ForeColor="red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                        ...
                        <div>
                            ...
                            <asp:RequiredFieldValidator ID="rfvPostCode" runat="server" ErrorMessage="Address is Required" ControlToValidate="txtPostCode"
                                ForeColor="red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="revPostCode" runat="server" ErrorMessage="Post/Zip code Must be of 6 Numbers"
