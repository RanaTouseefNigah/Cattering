<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="catterng.Admin.Category" %>
        ...
        function ImagePreview(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function (e) {
                    $('#<%=imgCategory.ClientID %>').attr('src', e.target.result).width(200);
                };
